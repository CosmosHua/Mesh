...
Load = lambda dir,w: np.load(path.join(dir,w), allow_pickle=True)
...
class PNet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = Load(weights_path, 'weights/pnet.npy')[()]
...
class RNet(nn.Module):
    ...
    def __init__(self):
        ...
        weights_path = path.dirname(__file__)
        weights = Load(weights_path, 'weights/rnet.npy')[()]
...
class ONet(nn.Module):
    ...
    def __init__(self):
        ...
        weights_path = path.dirname(__file__)
        weights = Load(weights_path, 'weights/onet.npy')[()]
