...
model_names += ['mobilenetv2', 'shufflenetv2']
...
def main():
    ...
    if args.arch.startswith('shufflenetv2'):
        model = ShuffleNet2(width_mult=args.width_mult)
    ...
    if args.evaluate:
        if os.path.isfile(args.evaluate):
            ...
            print("=> No Model Found: '{}'".format(args.evaluate))
    ...
    if args.evaluate: validate(val_loader, model, criterion)
